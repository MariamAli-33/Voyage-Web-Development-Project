        ...
        <div class="col-sm">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-dark m-2">
                    ...
                    <li class="breadcrumb-item"><a href="profile.html">My Profile</a></li>
        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4" id="main">
                <div
                    ...
                    <h1 class="h2 text-uppercase m-3" id="mainBoxHeading">Edit Your Profile</h1>
                        ...
                        <div class="row row-cols row-cols-md-8">
                            <form action="editprofile.php" method="POST" name="form1">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" placeholder="Password of your account"
