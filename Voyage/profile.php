...
A.Province,',',
A.Country
)as address1,P.Age,U.UserName,U.pass
...
<body>
  ...
  <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow ">
    <a class="navbar-brand col-md-3 col-lg-2 mr-0 p-4" href="#"> <?php echo $id;
    ?> </a>
    ...
    <div class="col-sm">
        <nav aria-label="breadcrumb" >
            <ol class="breadcrumb bg-dark m-2">
              ...
              <li class="breadcrumb-item active text-bold" aria-current="page">My Profile</li>
            </ol>
          </nav>
    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="information">
                                        ...
                                        <li class="infoItems"><i class="fas fa-chalkboard-teacher"></i><span
                                                class="infoItemsLabel">Age</span><span class="infoItemsDes">
                                                <?php echo "</td>".$res['Age']."</td>"?></span> </span>
                                        </li>
                                    </ul>
                                    ...
                                    <ul class="information">
                                        <li class="infoItems"><i class="fas fa-birthday-cake"></i><span
                                                ...
                                                class="infoItemsDes"><?php echo "</td>".$res['dateofbirth']."</td>"?>
                                                </span>
                                        </li>
