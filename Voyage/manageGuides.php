...
$id=$_SESSION['id'];
$sql="SELECT G.GuideID, P.FirstName, P.CNIC, P.Email, G.Speciality_areas, G.Years_of_Experience, G.No_of_tours_guided, A.Country, A.Province, A.City, A.Street, A.HouseNO
FROM TourGuide G join (Person P join Address A on P.AddressID=A.AddressID) on G.PersonID=P.PersonID";
  ...
  <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow ">
    ...
    <div class="col-sm">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-dark m-2">
          ...
          <li class="breadcrumb-item active text-bold" aria-current="page">Managing Guides</li>
        </ol>
      </nav>
    </div>
    ...
    <ul class="navbar-nav px-3">
      <li class="nav-item text-nowrap">
        <a class="nav-link" href="#" style="color:  rgb(255, 255, 255); font-size: 15px;"> Log Out <span><i
    ...
    <div class="row">
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse shadow-lg bg-white rounded">
        <div class="sidebar-sticky pt-5">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="manageGuides.php">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4" id="main">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-4 m-2 border-bottom">
          <h1 class="h2 text-uppercase mt-3" id="mainBoxHeading">Managing Tour Guides</h1>
                            ...
                            <table class="table">
                                <thead class="thead-dark">
                                    <tr>
                                        ...
                                        <th scope="col">Speciality Areas</th>
                                        <th scope="col">Years of Experience</th>
                                        <th scope="col">No of tours guided</th> 
                                        <th scope="col"></th>  
                                    </tr>
                                </thead>
                                <tbody>
...
echo "<td>" . $row['Speciality_areas'] . "</td>";
echo "<td>" . $row['Years_of_Experience'] . "</td>";
echo "<td>" . $row['No_of_tours_guided'] . "</td>";
echo '<td><a href="delete_guide.php?id=' . $row['GuideID'] . '" class="delete">Delete</a></td>';
