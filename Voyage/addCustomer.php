    ...
    <div class="col-sm">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-dark m-2">
          ...
          <li class="breadcrumb-item"><a href="manageCustomers.php">Managing Customer</a></li>
          <li class="breadcrumb-item active text-bold" aria-current="page">New Customer</li>
        </ol>
      </nav>
    </div>
      ...
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse shadow-lg bg-white rounded">
        <div class="sidebar-sticky pt-5">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link " href="manageAttractions.html">
      ...
      <!-- SideMenu End -->
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4" id="main">
                <div
                    ...
                    <h1 class="h2 text-uppercase mt-3" id="mainBoxHeading">Add New Customer</h1>
                    ...
                    <div class="col-md-6 shadow bg-white rounded" id="reservationForm">
                        <div class="row row-cols row-cols-md-8">
                           <h4>Add New Customer</h4>
                            <form method="get" action="addCustomer1.php">
                                <div class="form-row">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  name="Prov" placeholder="HXXXX"  required>
                                          </div>
                                    </div>
                                      <div class="col-md-6">
                                        <div class="form-group">
